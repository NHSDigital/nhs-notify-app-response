...
data "aws_iam_policy_document" "kms" {
  ...
  statement {
    ...
    condition {
      ...
      values = [
        "arn:aws:sqs:${var.region}:${var.aws_account_id}:${var.project}-${var.environment}-response-inbound-event-queue",
        "arn:aws:sqs:${var.region}:${var.aws_account_id}:${var.project}-${var.environment}-response-inbound-event-dlq",
      ]
    }
  }
  statement {
